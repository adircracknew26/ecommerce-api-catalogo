...
Este proyecto es un microservicio desarrollado en Django y Django REST Framework, se usa para administrar los productos disponibles, sus precios y las existencias (stock). Interacción: Proveedor de datos. El Equipo 3 consumirá esta API para validar precios y disponibilidad antes de crear un pedido.
...
GET /api/products// Muestra el detalle completo de un producto específico.
